# SAGE v2.1 — Scaled AI Guide for Everything
...
| **Unleash** | `search`, `get_content` | Internal reality: Jira tickets (bugs, known issues), Slack threads, internal worklogs. Not product docs. |
...
| Configuration how-to | Z2 only. Add Unleash only if Z2 result mentions known edge cases. |
...
- **Use for bugs, known issues, Jira tickets, Slack threads, internal worklogs.** Not for product documentation.
